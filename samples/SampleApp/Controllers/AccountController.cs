...
namespace SampleApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var cibt = HttpContext.Request.Cookies;

            //var res = await HttpContext.AuthenticateAsync("Identity.External");
        ...
        private async Task<ExternalLoginInfo> GetExternalLoginInfoAsync(string expectedXsrf = null)
        {
            ...
            var providerDisplayName = test.FirstOrDefault(p => p.Name == provider)?.DisplayName
                                      ?? provider;
        ...
        //private virtual async Task<IEnumerable<AuthenticationScheme>> GetExternalAuthenticationSchemesAsync()
        //{
        //    var schemes = await _signInManager.GetExternalAuthenticationSchemesAsync.GetAllSchemesAsync();
